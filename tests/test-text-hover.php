...
class Text_Hover_Test extends WP_UnitTestCase {
	...
	public function test_plugin_framework_class_name() {
		$this->assertTrue( class_exists( 'c2c_TextHover_Plugin_043' ) );
	}

	public function test_plugin_framework_version() {
		$this->assertEquals( '043', c2c_TextHover::get_instance()->c2c_plugin_version() );
	}

	public function test_version() {
		$this->assertEquals( '3.7', c2c_TextHover::get_instance()->version() );
	}
